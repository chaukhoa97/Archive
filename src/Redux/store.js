...
const counterReducer = (
  state = { counter: 100, showCounter: true },
  action
) => {
  switch (action.type) {
    case "increment":
      //! Luôn luôn return một State object mới. State dc return này sẽ overwrite default state ở line 5 -> Ko dc mutate trực tiếp ntn: `state.counter += 1`, có Redux toolkit thì ok (slice1 line 14)
