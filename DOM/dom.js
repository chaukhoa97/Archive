...
//! Get all <input> with the attribute "selected" and has the attribute "value" that is not blank; and all elements having 'yolo' class
var test = document.querySelectorAll(
  'input[selected][type="checkbox"]:not([value=""]), .yolo'
)
let dataQuery = document.querySelector("button[data-id='some-id']")
